    ...
    if len(face_encodings) > 0:
        ...
        for face_encoding in face_encodings:
            ...
            if True in matches:
                ...
                # Speak the recognized name using espeak
               
                espeak.synth("I can recognize the person in front of you. Their name is")
                espeak.synth(name)
        ...
        # No face detected
        espeak.synth("I can't recognize any person near you.")
